...
def main_f(args, layer_key, reinitialized_layer_list):
...
#     args = parser.parse_args()
    ...
    reinitialize_weight_file = reinitialize_weights(layer_key, reinitialized_layer_list)
    state_dict = torch.load(reinitialize_weight_file, map_location="cpu")
    
    args.output_dir = args.output_dir+'/'+ layer_key
